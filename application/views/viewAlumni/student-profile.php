                                ...
                                <div class="modal-footer background-login">
                                   ...
                                   <!--Project tab -->
								    ...
								    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-xs  btn-primary" data-toggle="modal" onClick = "editProjectDetailsDB(<?php echo $valuep['project_id']?>)" data-target="#editProjectModal">Edit</button>
                                            <button type="button" name="deleteProject" id="<?php echo $valuep['project_id']?>" onClick = "deleteProjectDetailsDB(<?php echo $valuep['project_id']?>)" class="btn btn-xs btn-danger">Delete</button>
    ...
    <div class="vd_mega-menu-wrapper">
        <div class="vd_mega-menu">
            ...
            <li class="one-big-icon mega-li mgl-10"> 
                <a href="index.php" class="mega-link" data-action="click-trigger">
                    <span class="mega-icon"><img src="<?php echo base_url(); ?>img/avatar/userUploads/<?php echo $stuProfile["profilePicture"]; ?>"></span> 
                    <span class="badge vd_bg-red">10</span>        
                </a>
		           ...
		           <div class="content-list content-image content-menu">
                       <div data-rel="scroll">	
                           <ul class="list-wrapper pd-lr-10">
                               <li> 
                                   <a href="#"> 
                    		           <div class="menu-icon"><img src="<?php echo base_url(); ?>img/avatar/userUploads/<?php echo $stuProfile["profilePicture"]; ?>"></div> 
                                       <div class="menu-text"> Do you play or follow any sports?
                            	       <div class="menu-info">
                                           <span class="menu-date">12 Minutes Ago </span>
                                           </div>
                                ...
                                <li class="align-right"> 
                                    <a href="#"> 
                                        <div class="menu-icon"><img alt="example image" src="<?php echo base_url(); ?>img/avatar/avatar-2.jpg"></div>  
        ...
        <li class="profile mega-li pdlr-15 bordered"> 
            <a class="mega-link" href="#"  data-action="click-trigger"> 
                <a href= "<?php echo site_url("alumniChatController");?>" class="menu-name openChatPage">
        	    ...
        	    <div class="content-list  content-image">
                    <div data-rel="scroll">
                        <ul class="list-wrapper pd-lr-10">
                            ...
                            <li>  
                                <a href="#"> 
                                    <div class="menu-icon"><img src="<?php echo base_url(); ?>img/avatar/avatar-2.jpg" alt="example image"></div> 
                            ...
                            <li>  
                                <a href="#"> 
                                    <div class="menu-icon"><img src="<?php echo base_url(); ?>img/avatar/avatar-3.jpg" alt="example image"></div> 
